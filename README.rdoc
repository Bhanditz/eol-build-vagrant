...
=== Tweak Your Local Environment
  ...
  cp eol/config/database.yml eol_php_code/config; \
  cp eol_php_code/config/environments/local.rb.sample \
  eol_php_code/config/environments/local.rb
...
the Vagrant box for EOL.
  ...
  # Local
  % vagrant package --output eol-rails
...
Once the ssh key is setup run:
  ...
  % cp vendor/eol_org/php_config/environments/test.php ../eol_php_code/config/environments/test.php
  % cp vendor/eol_org/php_config/environments/test.php ../eol_php_code/config/environments/development.php

Currently you need to make sure Solr is running with:
